...
class GameWidget(QWidget):
    ...
    def __init__(self,parent=None):
        ...
        self.winlable.hide()
        #定义一个棋子标识的lable
        self.chesslable=QLabel(self)
        self.chesslable.setPixmap(QPixmap('source/标识.png'))
        self.chesslable.setFixedSize(30,30)
        self.chesslable.hide()
        #定义一个棋子标识的lable
